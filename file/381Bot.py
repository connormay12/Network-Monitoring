...
# Bot Details
bot_email = '381BotConnor' #Fill in your Teams Bot email#
...
bot_url = "https://8780-66-168-16-69.ngrok.io" #Fill in the ngrok forwarding address#
...
# Add Bot's Commmands
bot.add_command(
    "save config", "Save the running-config to the startup-config.", netmiko_copyrunstart)
bot.add_command(
    "create loopback1", "Create Loopback1 on CSRV1.", netconf_createloopback)
bot.add_command(
    "show ip interface brief", "Show ip interface brief on routers.", ansible_showipinterfacebrief)
bot.add_command(
    "genie robot", "Start genie robot.", genie_robot)
bot.add_command(
    "open genie log.html", "Open the genie log.html.", html_open)
bot.add_command(
    "open genie compare", "Open the genie log.html and compare it", genie_robot_compare)
bot.add_command(
    "genie disaster initial", "Initialize genie robot and open log.html", genie_disaster_initial)
bot.add_command(
    "genie disaster compare", "Open the genie log.html and compare it", genie_disaster_compare)
bot.add_command(
    "genie disaster save ip", "Save the new ip to text file", genie_disaster_saveip)
bot.add_command(
